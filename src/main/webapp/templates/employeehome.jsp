    ...
    <ul class="navbar-menu">
      <li class="dropdown">
        ...
        <ul class="dropdown-menu">
          <li><a href="waitinglistemployees.jsp">Waiting List</a></li>
          <li><a href="newrecruits.jsp">New Recruits</a></li>
          <li><a href="workingemployees.jsp">Working Employees</a></li>
        </ul>
      </li>
      <li class="dropdown">
        <a href="department.jsp">Departments</a>
      </li>
      <li><a href="./adminwlist.jsp">Reports</a></li>
      <li class="dropdown">
